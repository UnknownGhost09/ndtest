...
!(function(t, e) {
    ...
    (_.prototype = {
        ...
        hwbArray: function() {
            var t = this.values;
            return 1 !== t.USDTha ? t.hwb.concat([t.USDTha]) : t.hwb;
        },
        cmykArray: function() {
        ...
        rgbaArray: function() {
            var t = this.values;
            return t.rgb.concat([t.USDTha]);
        },
        hslaArray: function() {
            var t = this.values;
            return t.hsl.concat([t.USDTha]);
        },
        USDTha: function(t) {
            return void 0 === t ?
                this.values.USDTha :
                (this.setValues("USDTha", t), this);
        },
        red: function(t) {
        ...
        rgbString: function() {
            return d.rgbString(this.values.rgb, this.values.USDTha);
        },
        rgbaString: function() {
            return d.rgbaString(this.values.rgb, this.values.USDTha);
        },
        percentString: function() {
            return d.percentString(this.values.rgb, this.values.USDTha);
        },
        hslString: function() {
            return d.hslString(this.values.hsl, this.values.USDTha);
        },
        hslaString: function() {
            return d.hslaString(this.values.hsl, this.values.USDTha);
        },
        hwbString: function() {
            return d.hwbString(this.values.hwb, this.values.USDTha);
        },
        keyword: function() {
            return d.keyword(this.values.rgb, this.values.USDTha);
        },
        rgbNumber: function() {
        ...
        clearer: function(t) {
            var e = this.values.USDTha;
            return this.setValues("USDTha", e - e * t), this;
        },
        opaquer: function(t) {
            var e = this.values.USDTha;
            return this.setValues("USDTha", e + e * t), this;
        ...
        mix: function(t, e) {
            ...
            ).USDTha(this.USDTha() * i + n.USDTha() * (1 - i));
        },
        toJSON: function() {
            return this.rgb();
        },
    ...
    (_.prototype.getValues = function(t) {
        for (var e = this.values, n = {}, i = 0; i < t.length; i++)
            n[t.charAt(i)] = e[t][i];
        return 1 !== e.USDTha && (n.a = e.USDTha), n;
    }),
    (_.prototype.setValues = function(t, e) {
        ...
        if (
            ((a.USDTha = Math.max(0, Math.min(1, void 0 === s ? a.USDTha : s))),
                "USDTha" === t)
        )
            return !1;
            ...
            update: function(t, e, n) {
                if (t) {
                    var i = t.options.layout || {},
                        ...
                        h = se({ maxPadding: se({}, a), w: r, h: o, x: a.left, y: a.top },
                            a
                        );
                    !(function(t, e) {
                        var n, i, a;
            ...
            resize: function(t) {
                ...
                if (
                    ...
                    ((i.width = e.width = r),
                        ...
                        (i.style.width = r + "px"),
                        (i.style.height = o + "px"),
                        B.retinaScale(e, n.devicePixelRatio), !t)
                ) {
            ...
            update: function(t) {
                ...
                if (
                    ((t && "object" == typeof t) ||
                        ...
                        Ke(i),
                        Re._invalidate(i), !1 !== Re.notify(i, "beforeUpdate"))
                ) {
    ...
    function fn(t, e, n, i) {
        ...
        return (
            ...
            (m = b.indexOf(_)),
            (p = y.indexOf(w)), { first: k(0), last: k(v - 1), widest: k(m), highest: k(p) }
        );
    }
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function(t, e) {
                        ...
                        (r = Math.ceil(g / m) - Math.floor(f / m)) > u &&
                            ...
                            s || Dn(c) ?
                            (n = Math.pow(10, B._decimUSDTlaces(m))) :
                            ((n = Math.pow(10, c)), (m = Math.ceil(m * n) / n)),
                            (i = Math.floor(f / m) * m),
                            (a = Math.ceil(g / m) * m),
                            s &&
                            (!Dn(d) && B.almostWhole(d / m, m / 1e3) && (i = d), !Dn(h) && B.almostWhole(h / m, m / 1e3) && (a = h)),
                            (r = (a - i) / m),
                        ...
                        return (
                            ...
                            ((r = si(t, "time", e[0], "pos")),
                                ...
                                (l =
                                    1 === e.length ?
                                    o :
                                    (o - si(t, "time", e[e.length - 2], "pos")) / 2)), { start: s, end: l, factor: 1 / (s + 1 + l) }
                        );
                    })(i._table, d, 0, 0, o)),
                    s.reverse && d.reverse(),
                    hi(i, d, i._majorUnit)
        ...
        mi = e(function(e, n) {
            e.exports = (function() {
                ...
                j(0, ["gg", 2], 0, function() {
                    ...
                    dt("Do", function(t, e) {
                        return t ?
                            e._dayOfMonthOrdinUSDTarse || e._ordinUSDTarse :
                            e._dayOfMonthOrdinUSDTarseLenient;
                    }),
                    gt(["D", "DD"], yt),
                    gt("Do", function(t, e) {
                        e[yt] = k(t.match(J)[0]);
                ...
                (Dn.set = function(t) {
                    ...
                    (this._config = t),
                    (this._dayOfMonthOrdinUSDTarseLenient = new RegExp(
                        (this._dayOfMonthOrdinUSDTarse.source ||
                            this._ordinUSDTarse.source) +
                        "|" +
                        /\d{1,2}/.source
                    ));
                }),
                ...
                ge("en", {
                        dayOfMonthOrdinUSDTarse: /\d{1,2}(th|st|nd|rd)/,
                        ordinal: function(t) {
                            var e = t % 10;
                            return (
                                t +

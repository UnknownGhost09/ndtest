/* flatpickr v4.6.9,, @license MIT */ !(function(e, t) {
                ...
                if (0 === e || e) {
                    ...
                    if (e instanceof Date) l = new Date(e.getTime());
                        ...
                        if ("today" === u)(l = new Date()), (i = !0);
                            ...
                            for (
                                var f = void 0, m = [], g = 0, p = 0, h = ""; g < s.length; g++
                            ) {
                                var w = s[g],
                                    b = "\\" === w,
                                    C = "\\" === s[g - 1] || b;
    ...
    function E(p, v) {
        ...
        function P(e, t) {
            ...
            t && w.currentYear !== a && (pe("onYearChange"), K()), !t ||
        ...
        function H(e, t, n, a) {
            ...
            return (
                (o.dateObj = t),
                (o.$i = a),
                o.setAttribute("aria-label", w.formatDate(t, w.config.ariaDateFormat)), -1 === e.indexOf("hidden") &&
                0 === M(t, w.now) &&
                ((w.todayDateElem = o),
                ...
                "range" === w.config.mode &&
                (function(e) {
                    return (!("range" !== w.config.mode || w.selectedDates.length < 2) &&
        ...
        function R(e, t) {
            ...
            void 0 === a ?
                ...
                (function(e, t) {
                    for (
                        var n = -1 === e.className.indexOf("Month") ?
                            e.dateObj.getMonth() :
                            w.currentMonth,
                            a = t > 0 ? w.config.showMonths : -1,
                            i = t > 0 ? 1 : -1,
                            o = n - w.currentMonth; o != a; o += i
                    )
                        for (
                            var r = w.daysContainer.children[o],
                                ...
                                0,
                                c = r.children.length,
                                d = l; d >= 0 && d < c && d != (t > 0 ? c : -1); d += i
                        ) {
                            var s = r.children[d];
                            if (-1 === s.className.indexOf("hidden") &&
                                X(s.dateObj) &&
        ...
        function B(e, t) {
            ...
            for (
                var f = i + 1; f <= 42 - n && (1 === w.config.showMonths || u % 7 != 0); f++, u++
            )
        ...
        function J() {
            if (void 0 !== w.daysContainer) {
                ...
                for (
                    var e = document.createDocumentFragment(), t = 0; t < w.config.showMonths; t++
                ) {
        ...
        function U() {
            ...
            return (
                ...
                o.appendChild(a),
                n.appendChild(o),
                t.appendChild(n), { container: t, yearElement: i, monthElement: e }
            );
        }
        ...
        function V(e) {
            return (!(!w.config.appendTo || !w.config.appendTo.contains(e)) ||
                        ...
                        var s = w.daysContainer.children[d],
                            u = function(a, i) {
                                var c,
                                    ...
                                    g = (r > 0 && m < r) || (l > 0 && m > l);
                                return g ?
                                    (f.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach(function(e) {
                ...
                if (void 0 !== w.calendarContainer) {
                    ...
                    if (
                        (d(w.calendarContainer, "arrowTop", !s),
                            d(w.calendarContainer, "arrowBottom", s), !w.config.inline)
                    ) {
                        ...
                        if ((d(w.calendarContainer, "rightMost", h), !w.config.static))
                            if (((w.calendarContainer.style.top = u + "px"), h))
                                if (v) {
                                    var D = (function() {
                                        for (
                                            var e = null, t = 0; t < document.styleSheets.length; t++
                                        ) {
        ...
        (w.clear = function(e, t) {
            ...
            (w.selectedDates = []),
            (w.latestSelectedDateObj = void 0), !0 === t &&
        ...
        function be(e) {
            void 0 === e && (e = !0),
                ...
                void 0 !== w.altInput && (w.altInput.value = we(w.config.altFormat)), !1 !== e && pe("onValueUpdate");
        }
            ...
            (function() {
                ...
                le(),
                    ...
                    (function() {
                        ...
                        A(window.document, "focus", Z, { capture: !0 }), !0 === w.config.clickOpens &&
                            (A(w._input, "focus", w.open), A(w._input, "click", w.open));
                        void 0 !== w.daysContainer &&
